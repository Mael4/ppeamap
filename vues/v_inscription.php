...
?>
		...
		<form method='POST' action='index.php?uc=connexion&action=inscription'>
				<label for='login_utilisateur'>Login</label>
				<input name='login_utilisateur' id='login_utilisateur' type='text' class='form-control' size='30' maxlength='45' onblur="checkLogin()" style="border-color: rgba(255, 0, 0, 1); box-shadow: 0 0 8px rgba(255, 0, 0, 1);">
				...
				<label for='mail_utilisateur'>Mail</label>
				<input name='mail_utilisateur' id='mail_utilisateur' type='text' class='form-control' size='30' maxlength='45' onblur="checkMail()" style="border-color: rgba(255, 0, 0, 1); box-shadow: 0 0 8px rgba(255, 0, 0, 1);">
